        ...
        <div className="news-content">
            ...
            <div className="news-section">
                <div className="headline">
                    ...
                    <h2 className="headline-title">Lorem ipsum aaaaaaaaaaaaaaaaaaaaaaaaaaa aaaaaaaaaaaaaaaaaaaaaa aaaaaaaaaaaaaaaa... <i className="fa-regular fa-bookmark bookmark"></i></h2>
                </div>
                <div className="news-grid">
                    <div className="news-grid-item">
                        <img src={techImg} alt="News Image" />
                        <h3>lorem ipsum ...<i className="fa-regular fa-bookmark bookmark"></i> </h3>
                    </div>
                      <div className="news-grid-item">
